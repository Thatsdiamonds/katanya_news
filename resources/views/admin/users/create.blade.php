            ...
            <x-ui.card>
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-ui.input id="email" name="email" type="email" value="{{ old('email') }}" required class="mt-1 w-full" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-ui.input id="password" name="password" type="password" class="mt-1 w-full" required />
                    </div>
