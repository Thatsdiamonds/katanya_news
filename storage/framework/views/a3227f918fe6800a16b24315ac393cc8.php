...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'avatar','value' => __('Profile Picture')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            <?php if($user->avatar): ?>
                <div class="mt-2 mb-3">
                    <img src="<?php echo e(Storage::disk('public')->url($user->avatar)); ?>" alt="Avatar" class="w-20 h-20 rounded-full object-cover shadow-sm ring-1 ring-gray-900/10">
                </div>
            <?php endif; ?>
            <input type="file" name="avatar" id="avatar" accept="image/*" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-gray-50 file:text-gray-700 hover:file:bg-gray-100 focus:outline-none">
...
<?php /**PATH C:\Users\Lenovo\Documents\ENT News\news\resources\views\profile\partials\update-profile-information-form.blade.php ENDPATH**/ ?>